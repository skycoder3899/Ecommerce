package com.monk.commerce.cop.service;
...
import com.monk.commerce.cop.dto.*;
import com.monk.commerce.cop.model.*;
...
import com.monk.commerce.cop.processor.CouponProcessor;
import com.monk.commerce.cop.processor.CouponProcessorFactory;
import com.monk.commerce.cop.repository.CouponRepository;
...
public class CouponService {
    ...
    public UpdatedCartDTO applyCoupon(Long couponId, Cart cart) {
        ...
        Coupon coupon = couponRepository.findById(couponId)
                .orElseThrow(() -> new InvalidCouponDetailsException("Coupon with ID " + couponId + " not found"));
    ...
    public Coupon getCouponById(Long id) {
        ...
        return couponRepository.findById(id)
                .orElseThrow(() -> new InvalidCouponDetailsException("Coupon with ID " + id + " not found"));
    }
    ...
    public void deleteCoupon(Long id) {
        ...
        if (!couponRepository.existsById(id)) {
            throw new InvalidCouponDetailsException("Coupon with ID " + id + " not found");
        }
